...
export const fetchSuppliers = () => dispatch => {
    fetch('http://127.0.0.1/lacorniche/api/get_suppliers.php')
        .then(res => res.json())
        .then(suppliers => {
...
export const fetchSupplier = (id) => dispatch => {
    alert("id "+id)
    fetch('http://127.0.0.1/lacorniche/api/get_supplier?supplier_id='+id)
        .then(res => res.json())
        .then(supplier => {
...
export const createSupplier=(supplierData)=>dispatch=>{
    fetch('http://127.0.0.1/lacorniche/api/add_supplier.php',{
        method:'POST',
        headers:{
...
export const updateSupplier=(supplierData)=>dispatch=>{
    fetch('http://127.0.0.1/lacorniche/api/update_supplier.php',{
        method:'PUT',
        headers:{
            'content-type':'application/json'
        },
