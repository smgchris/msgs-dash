...
export const fetchProductCategs = () => dispatch => {
    console.log("here");
    fetch('https://lacorniche.rw/api/get_categories.php')
        .then(res => res.json())
        .then(categories => {
...
export const createProductCateg = categoryData => dispatch => {
    fetch('https://lacorniche.rw/api/add_category.php', {
        method: 'POST',
        headers: {
...
export const updateCateg = categoryData => dispatch => {
    fetch('https://lacorniche.rw/api/update_category.php', {
        method: 'PUT',
        headers: {
            'content-type': 'application/json'
        },
...
export const deleteProductCateg = (id) => dispatch => {
    fetch('https://lacorniche.rw/api/delete_category.php', {
        method: 'DELETE',
    }).then(() => 
        dispatch({
            type: DELETE_PRODUCTCATEG_SUCCESS,
