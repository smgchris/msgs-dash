...
export const fetchStockProducts = () => dispatch => {
    ...
    fetch('https://lacorniche.rw/api/get_stock_products.php')
        .then(res => res.json())
        .then(stockProducts => {
...
export const createStockProduct = stockProductData => dispatch => {
    fetch('https://lacorniche.rw/api/add_stock_product.php', {
        method: 'POST',
        headers: {
...
export const updateStockProduct = stockProductData => dispatch => {
    fetch('https://lacorniche.rw/api/update_stock_product.php', {
        method: 'PUT',
        headers: {
            'content-type': 'application/json'
        },
