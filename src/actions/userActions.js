...
export const createUser = userData => dispatch => {
    ...
    fetch('http://127.0.0.1/lacorniche/api/register_user.php', {
        method: 'POST',
        mode: 'cors',
        headers: {
...
export const updateUser = userData => dispatch => {
    ...
    fetch('http://127.0.0.1/lacorniche/api/update_user.php', {
        method: 'PUT',
        headers: {
            'content-type': 'application/json'
        },
...
export const deleteUser = (id) => dispatch => {
    ...
    fetch('http://127.0.0.1/lacorniche/api/delete_user?id='+id, {
