...
export const fetchRequests = () => dispatch => {
    fetch('https://lacorniche.rw/api/get_stock_logs.php')
        .then(res => res.json())
        .then(requests => {
...
export const createRequest = userData => dispatch => {
    ...
    fetch('https://lacorniche.rw/api/add_stock_log.php', {
        method: 'POST',
        headers: {
...
export const updateRequest = userData => dispatch => {
    console.log(JSON.stringify(userData));
   fetch('https://lacorniche.rw/api/update_stock_log.php', {
       method: 'PUT',
       headers: {
           'content-type': 'application/json'
       },
...
export const fetchBuffet = () => dispatch => {
    fetch('https://lacorniche.rw/api/get_orders.php')
        .then(res => res.json())
        .then(Buffet => {
...
export const buffetRequest = userData => dispatch => {
    console.log(JSON.stringify(userData));
   fetch('https://lacorniche.rw/api/add_order.php', {
       method: 'POST',
       headers: {
           'content-type': 'application/json'
       },
