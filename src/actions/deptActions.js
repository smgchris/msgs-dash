...
export const fetchDepts = () => dispatch => {
    fetch('https://lacorniche.rw/api/get_departments.php')
        .then(res => res.json())
        .then(depts => {
...
export const fetchDeptUsers = (id) => dispatch => {
    fetch('https://lacorniche.rw/api/get_dept_users.php?id='+id)
        .then(res => res.json())
        .then(deptUsers => {
...
export const createDept=(deptData)=>dispatch=>{
    fetch('https://lacorniche.rw/api/add_department.php',{
        method:'POST',
        headers:{
...
export const updateDept=(deptData)=>dispatch=>{
    fetch('https://lacorniche.rw/api/update_dept.php',{
        method:'PUT',
        headers:{
            'content-type':'application/json'
        },
...
export const deleteDept = (id) => dispatch => {
    fetch('https://lacorniche.rw/api/delete_dept?id='+id, {
        method: 'DELETE',
    }).then(() => 
        dispatch({
            type: DELETE_DEPT_SUCCESS,
