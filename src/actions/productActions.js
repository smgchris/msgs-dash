...
export const fetchProducts = () => dispatch => {
    fetch('http://127.0.0.1/lacorniche/api/get_products.php')
        .then(res => res.json())
        .then(products => {
...
export const createProduct = productData => dispatch => {
    fetch('http://127.0.0.1/lacorniche/api/add_product.php', {
        method: 'POST',
        headers: {
...
export const updateProduct = productData => dispatch => {
    fetch('http://127.0.0.1/lacorniche/api/update_product.php', {
        method: 'PUT',
        headers: {
            'content-type': 'application/json'
        },
...
export const deleteProduct = (id) => dispatch => {
    fetch('http://127.0.0.1/lacorniche/api/delete_product.php?product_id='+id, {
        method: 'DELETE',
    }).then(() => 
        dispatch({
            type: DELETE_PRODUCT_SUCCESS,
