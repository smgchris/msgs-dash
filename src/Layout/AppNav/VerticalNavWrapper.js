...
import {MainNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav,LaCornicheNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <MetisMenu content={LaCornicheNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
            </Fragment>
        );
    }
