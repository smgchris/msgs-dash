...
class AddItemForm extends React.Component {
  ...
  onSubmit(e) {
    ...
    window.location.assign(`#/kitchen/manage-requests`)
  }
                  ...
                  <Col lg='6'>
                    ...
                    <FormGroup>
                      ...
                      <Input type="select" name="product" value={this.state.value} onChange={this.onChange} required>
                        ...
                        {this.props.stockProducts.filter(item=>item.quantity>0).map(stockProduct =>
                          <option value={stockProduct.stock_product_id}>
                            {stockProduct.product.product_name}{' (available: '}{stockProduct.quantity}{' '+stockProduct.unit+' )'}
                          </option>
                        )}
                      </Input>
